...
def get_args():
    ...
    parser.add_argument('--video_encoder_type', type=str, default='clip_vit_large_14_336px')
    parser.add_argument('--txt_encoder_type', type=str, default='clip_vit_large_14_336px')
